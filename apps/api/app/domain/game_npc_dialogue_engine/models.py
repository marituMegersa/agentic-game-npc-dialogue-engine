...
class AgenticGameNpcDialogueEngineSession(Base):
    __tablename__ = "game_npc_dialogue_engine_sessions"
...
class AgenticGameNpcDialogueEngineItem(Base):
    __tablename__ = "game_npc_dialogue_engine_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("game_npc_dialogue_engine_sessions.id"))
